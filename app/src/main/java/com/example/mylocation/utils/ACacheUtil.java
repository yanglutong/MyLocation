...
//    }
    ...
    public static void puttarget(String target) {//覆盖范围开关
        getACache().put("target", target);
    }

    public static String gettarget() {
        return getACache().getAsString("target");
    }


    public static void putoneself(String oneself) {//覆盖范围开关
        getACache().put("oneself", oneself);
    }

    public static String getoneself() {
        return getACache().getAsString("oneself");
    }
}

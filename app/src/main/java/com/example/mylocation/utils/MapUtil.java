...
import static com.example.mylocation.utils.BitmapUtil.bmEnd;
import static com.example.mylocation.utils.BitmapUtil.bmStart;
...
public class MapUtil {
     ...
     * @param location
     */
    public static LatLng convertTraceLocation2Map(BDLocation location) {
        if (null == location) {
            return null;
        }
...
//        if (CoordType.wgs84 == location.getCoorType()) {

 ...
 * 封装各种操作数据库的方法
 */
public class DBManagerGuijiView {
    ...
    public DBManagerGuijiView(Context context) throws SQLException {
        ...
        dao = ormHelper.getDao(GuijiViewBean.class);
    }
     ...
     * @thro
     */
    public int insertStudent(GuijiViewBean guijiViewBean) throws SQLException {
     ...
     * @throws SQLException
     */
    public void batchInsert(List<GuijiViewBean> guijiViewBeans) throws SQLException {
     ...
     * @throws SQLException
     */
    public List<GuijiViewBean> guijiViewBeans() throws SQLException {
        List<GuijiViewBean> list = dao.queryForAll();
        return list;
    }

    public GuijiViewBean forid(int id) throws SQLException {
        GuijiViewBean guijiViewBean = (GuijiViewBean) dao.queryForId(id);
     ...
     * @throws SQLException
     */
    public List<GuijiViewBean> queryGuanyu() throws SQLException {
        //Eq是equals的缩写
        //方法1
...
//        queryBuilder.orderBy("age",true);
     ...
     * @throws SQLException
     */
    public List<GuijiViewBean> queryData(int s) throws SQLException {
     ...
     * @throws SQLException
     */
    public int deleteStudent(GuijiViewBean guijiViewBean) throws SQLException {
        //只看id
        int delete = dao.delete(guijiViewBean);
        return delete;
    }
...
//        dao.execSQL("delete from tab_name");
     ...
     * @throws SQLException
     */
    public void updateStudent(GuijiViewBean guijiViewBean) throws SQLException {
//        guijiViewBean.setUp(91);
        dao.update(guijiViewBean);
    }

...
public interface RetrofitService {
    ...
    @POST(MyURL.UserAli)
    retrofit2.Call<com.example.mylocation.bean.DataAliBean> GETBaseStationAli(@Query("mnc") int mnc, @Query("lac") int lac, @Query("cellid") int ci, @Header("Authorization") String appKey, @Header("Content-Type") String Content);


    @POST(MyURL.UserAli)
    retrofit2.Call<com.example.mylocation.bean.DataAliBean> GETBaseStationAliCdm(@Query("sid") int sid, @Query("nid") int nid, @Query("cellid") int ci, @Header("Authorization") String appKey, @Header("Content-Type") String Content);
